...
const DestinationCard = ({ destination }) => {
  return (
    <div className="destination-card mt-8 h-[585px] mb-12 relative rounded-lg">
      ...
      <h3 className='text-[13px] font-medium text-left my-3'>Warranty Information: {destination.warrantyInformation}</h3>
        <span className='absolute top-3 right-2 bg-[#acabab] text-white flex items-center py-1 px-2 border-[1px] border-[lightgray] rounded-full text-[12px]'><span className='text-[#FFCD6B] mr-1'><FaStar /></span> {destination.rating}</span>
